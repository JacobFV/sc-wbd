...
\fancyhead[R]{\sffamily\scriptsize\color{muted}V9 \textperiodcentered\ Draft. Pending Development}
...
% VERSION -- bump when you edit this paper. It appears in the running head of
% every page after the first; the title page is deliberately bare. Currently V9.
\begin{document}
\thispagestyle{empty}
