...
Here, an empirical training run puts it at \(4\%\) of the gradient and watches it
lose. Neither figure was derived from the other, and the two disagree only in the
